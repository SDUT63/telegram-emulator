...
# Сюда нельзя класть то, чем человек может ответить на вопрос анкеты:
# «не знаю» — законный ответ на половину вопросов, и подменять его меню
# значит терять ответ. За этим следит тест.
ASK_WORDS = {
    "спросить", "хочу спросить", "у меня вопрос", "вопрос", "задать вопрос",
    "что спросить", "что можно спросить", "о чём можно спросить",
    "о чем можно спросить", "не знаю что спросить", "не знаю, что спросить",
    "темы", "покажи темы", "список тем", "меню", "подсказки", "подскажи",
    "подскажите", "справка", "справочник", "информация", "инфо",
    "что ты умеешь", "что умеешь", "чем поможешь", "чем ты поможешь",
    "не знаю с чего начать", "с чего начать", "с чего начинать",
    "/ask", "/faq", "/menu", "/topics",
}
