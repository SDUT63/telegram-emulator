...
#
# Текст ниже — Приложение А комплекта форм согласия
# (docs/Согласие-на-обработку-ПД-СДУТ.docx). Правится только вместе с ним,
# и при изменении смысла увеличивается CONSENT_VERSION: старые согласия
# остаются привязанными к той редакции, которую человек видел.
#
...
CONSENT = (
    ...
    "Кто собирает: АНО «Система долговременного ухода г. Тольятти».\n\n"
    ...
    "Кому передаём: только сотрудникам службы. В медицинскую организацию — "
    "лишь с вашего отдельного согласия.\n\n"
    "Сколько храним: пока вы не попросите удалить. Напишите «удалить» — "
    "сотрём всё и подтвердим.\n\n"
    "Полный текст: политика обработки персональных данных — в справочнике "
    "по кнопке «Открыть»."
)
